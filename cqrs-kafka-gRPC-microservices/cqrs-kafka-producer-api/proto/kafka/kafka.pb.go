...
func (x *TodoCreate) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *TodoCreate) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *TodoCreated) GetTodo() *Todo {
	if x != nil {
		return x.Todo
	}
	return nil
...
func (x *TodoUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TodoUpdated) ProtoMessage() {}

func (x *TodoUpdated) ProtoReflect() protoreflect.Message {
	mi := &file_kafka_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TodoUpdated.ProtoReflect.Descriptor instead.
func (*TodoUpdated) Descriptor() ([]byte, []int) {
	return file_kafka_proto_rawDescGZIP(), []int{4}
}

func (x *TodoUpdated) GetTodo() *Todo {
	if x != nil {
		return x.Todo
	}
	return nil
...
func (x *TodoDelete) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *TodoDeleted) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
var file_kafka_proto_rawDesc = []byte{
	...
	0x0a, 0x54, 0x6f, 0x64, 0x6f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	...
	0x65, 0x22, 0x32, 0x0a, 0x0a, 0x54, 0x6f, 0x64, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12,
	0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x44, 0x12,
	0x14, 0x0a, 0x05, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x54, 0x69, 0x74, 0x6c, 0x65, 0x22, 0xa0, 0x01, 0x0a, 0x04, 0x54, 0x6f, 0x64, 0x6f, 0x12, 0x0e,
	...
	0x69, 0x74, 0x6c, 0x65, 0x12, 0x38, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41,
	...
	,
...
var file_kafka_proto_goTypes = []interface{}{
	(*TodoCreate)(nil),          // 0: kafkaMessages.TodoCreate
	(*TodoUpdate)(nil),          // 1: kafkaMessages.TodoUpdate
	(*Todo)(nil),                // 2: kafkaMessages.Todo
	(*TodoCreated)(nil),         // 3: kafkaMessages.TodoCreated
	(*TodoUpdated)(nil),         // 4: kafkaMessages.TodoUpdated
	(*TodoDelete)(nil),          // 5: kafkaMessages.TodoDelete
	(*TodoDeleted)(nil),         // 6: kafkaMessages.TodoDeleted
	(*timestamp.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_kafka_proto_depIdxs = []int32{
	7, // 0: kafkaMessages.Todo.CreatedAt:type_name -> google.protobuf.Timestamp
	7, // 1: kafkaMessages.Todo.UpdatedAt:type_name -> google.protobuf.Timestamp
	2, // 2: kafkaMessages.TodoCreated.Todo:type_name -> kafkaMessages.Todo
	2, // 3: kafkaMessages.TodoUpdated.Todo:type_name -> kafkaMessages.Todo
